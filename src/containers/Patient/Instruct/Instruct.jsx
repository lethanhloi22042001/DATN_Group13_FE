    ...
    return (
      <main className="guide">
        <div>
          ...
          ></iframe>
          <a class="btn-google-map" target="_blank" href="https://maps.app.goo.gl/7c8cPock5pWcQuag9">
            Mở bằng Google Map
          </a>
        </div>
        <div className="container">
          ...
          <div className="guide-content">
            <div class="guide-info" data-testid="appointment-guide-information">
              <ul>
                <li>
                  Bác sĩ: {data?.doctorData?.firstName} {data?.doctorData?.lastName}
                </li>
                <li>
                  Thời gian::&nbsp;
            ...
            {faqs.map((faq, index) => {
              return (
                <AccordionItem key={index} active={this.state.active} handleToggle={this.handleToggle} faq={faq} />
              );
            })}
          </div>
        </div>
